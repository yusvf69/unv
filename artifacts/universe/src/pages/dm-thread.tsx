...
export default function DmThread() {
  ...
  return (
    <div className="container mx-auto max-w-2xl flex flex-col" style={{ height: "calc(100vh - 4rem)" }}>
      ...
      <div className="px-3 py-2 bg-amber-500/10 border-b border-amber-500/30 text-center text-[10px] sm:text-[11px] text-amber-700 dark:text-amber-300 leading-snug">
        الرسايل على السايت غير مشفّرة، والجهة المسؤولة لها الحق الكامل في الاطلاع على المحادثات متى لزم ذلك.
      </div>
